...
def fillram():
	...
	for i in range(256):
		file2.write("0000"+"\n")
	file2.close()	
register_dictionary={'R0':'000','R1':'001','R2':'010','R3':'011','R4':'100','R5':'101','R6':'110','R7':'111'}
opcode={'ADD':'0000','ADC':'0000','ADZ':'0000','ADI':'0001','NDU':'0010','NDC':'0010','NDZ':'0010','LHI':'0011','LW':'0100','SW':'0101','LM':'0110','SM':'0111','BEQ':'1100','JAL':'1000','JLR':'1001','NOP':'1111'}
lsb_3bits:{'ADD':'000','ADC':'010','ADZ':'001','NDU':'000','NDC':'010','NDZ':'001'}
